...
class EisMeasurementSetup:
    # mode: str  # Options: Impedance, Kinetic, Conductivity
    ...
    # mean_count: int
    # repeat: int
    # settling_param: None  # TODO
    # nonlin_spec: None  # TODO

    # Excitation Setting
    # exc_typ: str
    # exc_amp: Union[float, int]
    # measure_V_range: Union[float, int]
    # measure_I_range: Union[float, int]
